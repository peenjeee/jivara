...
export default function PatientPagination({ currentPage, totalPages, totalItems, pageSize, onPageChange }: PatientPaginationProps) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-b-3xl bg-white px-5 py-5 text-sm font-semibold text-muted sm:flex-row sm:items-center sm:justify-between sm:px-7">
      <p>Menampilkan {start} hingga {end} dari {totalItems} pasien</p>
